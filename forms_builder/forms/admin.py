...
form_admin_fieldsets = [
    (None, {"fields": ("evento", "titulo_boton", "title", "inicio_evento", ("status", "login_required",),
        ("publish_date", "expiry_date",),
        "intro", "content", "logos", "flyer", "portada", "button_text", "response", "redirect_url")}),
...
class FormAdmin(admin.ModelAdmin):
    ...
    inlines = (FieldAdmin,)
    list_display = ("title", "slug", "status", "email_copies",
                    "total_entries",)
